...
public class RoomController {
	...
	public ResponseEntity<Room> getRoomById(@PathVariable(value = "id") long roomId)
			...
			Room room = roomRepository.findById(roomId)
					.orElseThrow(()-> new ResourceNotFoundException("Sala nao encontrada:: " + roomId));
	...
	public ResponseEntity<Room> updateRoom(@PathVariable (value = "id") long roomId,
		...
		Room room = roomRepository.findById(roomId)
				.orElseThrow(()-> new ResourceNotFoundException("sala nao encontrada pelo id::" + roomId));
	...
	public Map<String, Boolean> deleteRooms(@PathVariable(value = "id") Long roomId)
		throws ResourceNotFoundException{
		Room room = roomRepository.findById(roomId)
				.orElseThrow(()-> new ResourceNotFoundException("Sala nao encontrada pelo id:" + roomId));
